...
internal object FlexionFabric {
   ...
   */
  private fun createFlexion(prefix: String?, base: String, postfix: String, tags: List<MorphologyTag>, mainTags: List<MorphologyTag>): FullFlexion {
    ...
    return FullFlexion(sourceBuilder.append(postfix).toString(), tags.toSet().union(mainTags.toSet()))
  }
   ...
   */
  private fun createFlexion(base: String, source: String, baseType: String, morphMap: Map<String, List<MorphologyTag>>): FullFlexion {
    ...
    return createFlexion(
      ...
      normalize(args[0]),
      morphMap[args[1]]!!,
      if (morphMap.contains(baseType)) morphMap[baseType]!! else emptyList<MorphologyTag>()
    )
  }
   ...
   */
  fun createLemma(base: String, paradigm: String, baseType: String, morphMap: Map<String, List<MorphologyTag>>): List<FullFlexion> {
